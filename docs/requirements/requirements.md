...
| REQ-PTT-007 | The firmware shall enforce a maximum continuous TX time from any PTT source. It shall be configurable (default 300 s, at least 10 s, no upper bound) and shall not be possible to disable. On expiry, PTT goes off and the host is notified. | constraints §6. | T | draft | #15 / #15 |
